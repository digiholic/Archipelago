...
all_items: typing.List[ItemData] = [
        ...
        ItemData(ItemNames.CreatureDeliveryPoint, ItemClassification.progression),
...
display_name_to_internal_name: typing.Dict[str, str] = {
        ...
        "Nuclear Apothecary": "AdvancedApothecary",
        "Hot Tub": "HotTub",
        ...
        "Priority Liquid Flow": "LiquidConduitPreferentialFlow",
        "Liquid Overflow Valve": "LiquidConduitOverflow",
        "Liquid Resevoir": "LiquidReservoir",
        ...
        "Aero Pod": "FlowerVaseHangingFancy",
        "Sun Lamp": "SunLamp",
