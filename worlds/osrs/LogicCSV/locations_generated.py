...
location_rows = [
	...
	LocationRow('Quest: Prince Ali Rescue', 'quest', ['Al Kharid', 'Central Varrock', 'Bronze Ores', 'Clay Ore', 'Sheep', 'Spinning Wheel', 'Draynor Village', 'Onion', ], [], [], 0),
	...
	LocationRow('Quest: Goblin Diplomacy', 'quest', ['Goblin Village', 'Draynor Village', 'Falador', 'South of Varrock', 'Onion', 'Redberry Bush', ], [], [], 0),
	LocationRow('Quest: Pirate\'s Treasure', 'quest', ['Port Sarim', 'Karamja', 'Mudskipper Point', 'Central Varrock', 'Falador', ], [], [], 0),
	...
	LocationRow('Quest: Ides of Milk', 'quest', ['Lumbridge Farms West', 'Lumbridge Farms East', 'Lumbridge', ], [], ['Progressive Weapons', 'Progressive Weapons', ], 0),
	...
	LocationRow('Mine Copper', 'mining', ['Bronze Ores', ], [SkillRequirement('Mining', 1), ], [], 0),
	LocationRow('Mine Tin', 'mining', ['Bronze Ores', ], [SkillRequirement('Mining', 1), ], [], 0),
	LocationRow('Mine Clay', 'mining', ['Clay Ore', ], [SkillRequirement('Mining', 1), ], [], 0),
	LocationRow('Mine Iron', 'mining', ['Iron Ore', ], [SkillRequirement('Mining', 15), ], [], 0),
	...
	LocationRow('Pet the Stray Dog in Varrock', 'general', ['Stray Dog', ], [], [], 0),
	LocationRow('Get Sent to Jail in Shantay Pass', 'general', ['Al Kharid', 'Port Sarim', ], [], [], 0),
	LocationRow('Have the Apothecary Make a Strength Potion', 'general', ['West Varrock', 'Red Spider Eggs', 'Limpwurt Root', ], [], [], 0),
	...
	LocationRow('Equip an Orange Cape', 'general', ['Draynor Village', 'Onion', 'Redberry Bush', ], [], [], 0),
	...
	LocationRow('Points: Ides of Milk', 'points', [], [], [], 0),
	LocationRow('Bingo: Forward Diagonal', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Reverse Diagonal', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 1', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Column 1', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 2', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Column 2', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 3', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Column 3', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 4', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Column 4', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 5', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Column 5', 'bingo', [], [], [], 0),
	LocationRow('Bingo: Row 6', 'bingo', [], [], [], 0),
