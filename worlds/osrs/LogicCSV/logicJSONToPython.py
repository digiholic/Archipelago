    ...
    for task_type, task_list in exportedJSON["challenges"].items():
        if task_type == "Quest" or task_type == "Diary":
            for quest_name, quest_data in task_list.items():
                ...
                if category == "quest" and "#" not in quest_name:
                    shortened_quest_name = "Quest: "+quest_name[2:quest_name.index("|~")]
                    task_csv_rows.append([shortened_quest_name,category,"","","","", "QuestTask"])
                else:
                    task_csv_rows.append([quest_name, category, "", "", "", "", "ManualTask"])
            ...
            for task_name, task_data in task_list.items():
                ...
                task_csv_rows.append([task_name, task_type, "", "", "", "", "ManualTask"])
